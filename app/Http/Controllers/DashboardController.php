...
class DashboardController extends Controller
{
    ...
    public function store(Request $request) { $data = $this->data($request); $data['user_id'] = $request->user()->id; Lead::create($data); return redirect()->route('leads.index')->with('success', 'Lead added to your pipeline.'); }
